# `PROPACK_jll.jl` (v0.2.0+0)

[![deps](https://juliahub.com/docs/PROPACK_jll/deps.svg)](https://juliahub.com/ui/Packages/PROPACK_jll/EWiRB?page=2)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/8e1b57d171c0c2010988f42bfc5534190817d551/P/PROPACK/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `PROPACK_jll.jl` have been built from these sources:

* compressed archive: https://github.com/optimizers/PROPACK/archive/v1.0.tar.gz (SHA256 checksum: `0d029a4c2cdcdb9b18a4fae77593a562f79406c3f79839ee948782b37974a10e`)

## Platforms

`PROPACK_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `PROPACK_jll.jl`:
...
* `LibraryProduct`: `libcpropack`
* `LibraryProduct`: `libdpropack`
* `LibraryProduct`: `libspropack`
* `LibraryProduct`: `libzpropack`
