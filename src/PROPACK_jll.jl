...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PROPACK_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("2c99449f-f194-5e92-8ff0-13814ff41dcf"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PROPACK", artifacts_toml) for e in artifacts["PROPACK"]]
...
if best_platform === nothing
    @debug("Unable to load PROPACK; unsupported platform $(triplet(platform_key_abi()))")
else
